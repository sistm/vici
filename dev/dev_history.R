...
golem::fill_desc(
  pkg_name = "vici", # The Name of the package containing the App
  pkg_title = "Vaccine Induced Cellular Immunogenicity: Acurate Estimation with Bivariate Modeling", # The Title of the package containing the App
  pkg_description = "Vaccine Induced Cellular Immunogenicity: Acurate Estimation with Bivariate Modeling", # The Description of the package containing the App
  author_first_name = "Boris", # Your First Name
  author_last_name = "Hejblum",  # Your Last Name
  author_email = "boris.hejblum@u-bordeaux.fr",      # Your Email
...
usethis::use_gpl3_license(name = "Boris Hejblum")  # You can set another licence here
